...
@else
    ...
    @section('title')
        ...
        @section('message') <p>Diligenciar los campos requeridos, para el debido registro red acádemica.</p> @endsection
    @endsection
    @section('content')
        <div class="container-fluid">
            <div class="tile w-100">
                <h4 class="tile title"><i class="fa fa-wpforms"></i> Registro red acádemica</h4>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control @error('red_nombre') is-invalid @enderror" name="red_accion"
                                    id="red_accion" cols="30" rows="10">{{ old('red_accion') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="red_fecha_afiliacion" type="date"
                                    ...
                                    name="red_fecha_afiliacion" value="{{ old('red_fecha_afiliacion') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="red_programa" type="text"
                                    ...
                                    value="{{ old('red_programa') }}" autocomplete="red_programa" autofocus>
                                @error('red_programa')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
