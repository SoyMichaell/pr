        ...
        <div class="container-fluid">
            <div class="tile w-100">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <label for="pr_codigo_prueba" class="col-md-12 col-form-label">{{ __('Codigo Prueba *') }}</label>
                        <div class="col-md-12">
                            <input id="pr_codigo_prueba" type="text"
                                class="form-control @error('pr_codigo_prueba') is-invalid @enderror" name="pr_codigo_prueba"
                                value="{{ $prueba->pr_codigo_prueba }}" autocomplete="pr_codigo_prueba" autofocus
                                disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="pr_fecha_presentacion" type="number"
                                ...
                                autocomplete="pr_fecha_presentacion" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="pr_grupo_referencial" type="text"
                                ...
                                autocomplete="pr_grupo_referencial" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="pr_grupo_referencia" type="text"
                                ...
                                autocomplete="pr_grupo_referencia" autofocus disabled>
