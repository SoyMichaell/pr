...
@else
    @extends('layouts.app')
    @section('title')
        <h1 class="titulo"><i class="fa fa-handshake-o"></i> Módulo convenios nacionales e internacionales</h1>
        @section('message')<p>Lista de registro convenios nacionales e internacionales</p>@endsection
    @endsection
    @section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <a class="btn btn-outline-danger btn-radius" href="{{ url('convenio/pdf') }}"
                                title="Generar reporte pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a>
                            <a class="btn btn-outline-primary btn-radius" href="{{ url('convenio/export') }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($convenios as $convenio)
                                    <tr>
                                        ...
                                        @if (Auth::user()->per_tipo_usuario == 1 || Auth::user()->per_tipo_usuario == 2)
                                            <td>
                                                <form action="{{ route('convenio.destroy', $convenio->id) }}"
                                                    method="POST">
                                                    <div class="d-flex">
