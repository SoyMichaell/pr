...
@section('content')
    <div class="container-fluid">
        <div class="tile w-100">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="pra_razon_social" class="col-md-12 col-form-label">{{ __('Nombre empresa *') }}</label>
                    <div class="col-md-12">
                        <input id="pra_razon_social" type="text"
                            class="form-control @error('pra_razon_social') is-invalid @enderror" name="pra_razon_social"
                            value="{{ $practica->pra_razon_social }}" autocomplete="pra_razon_social" autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <input id="pra_nit_empresa" type="number"
                            ...
                            value="{{ $practica->pra_nit_empresa }}" autocomplete="pra_nit_empresa" autofocus disabled>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <input id="pra_telefono" type="number"
                            ...
                            value="{{ $practica->pra_telefono }}" autocomplete="pra_telefono" autofocus disabled>
                        @error('pra_telefono')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-6">
                    <label for="pra_direccion" class="col-md-12 col-form-label">{{ __('Dirección empresa *') }}</label>
                    <div class="col-md-12">
                        <input id="pra_direccion" type="text"
                            class="form-control @error('pra_direccion') is-invalid @enderror" name="pra_direccion"
                            value="{{ $practica->pra_direccion }}" autocomplete="pra_direccion" autofocus disabled>
                        @error('pra_direccion')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="pra_fecha_inicio"
                        class="col-md-16 col-form-label">{{ __('Fecha inicio laboral *') }}</label>
                    <div class="col-md-12">
                        <input id="pra_fecha_inicio" type="date"
                            class="form-control @error('pra_fecha_inicio') is-invalid @enderror" name="pra_fecha_inicio"
                            value="{{ $practica->pra_fecha_inicio }}" autocomplete="pra_fecha_inicio" autofocus disabled>
                ...
                <div class="col-md-6">
                    <label for="pra_fecha_fin" class="col-md-16 col-form-label">{{ __('Fecha fin laboral ') }}</label>
                    <div class="col-md-12">
                        <input id="pra_fecha_fin" type="date"
                            class="form-control @error('pra_fecha_fin') is-invalid @enderror" name="pra_fecha_fin"
                            value="{{ $practica->pra_fecha_inicio }}" autocomplete="pra_fecha_fin" autofocus disabled>
                        @error('pra_fecha_fin')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
