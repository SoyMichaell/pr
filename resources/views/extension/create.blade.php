    ...
    @section('content')
        <div class="container-fluid">
            <div class="tile w-100">
                <h4 class="tile title"><i class="fab fa-wpforms"></i> Registro extensión e internacionalización</h4>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="ext_nombre" type="text"
                                    ...
                                    value="{{ old('ext_nombre') }}" autocomplete="ext_nombre" autofocus>
                                @error('ext_nombre')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="ext_tipo_evento" type="text"
                                    ...
                                    name="ext_tipo_evento" value="{{ old('ext_tipo_evento') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="ext_fecha_realizacion" type="date"
                                    ...
                                    name="ext_fecha_realizacion" value="{{ old('ext_fecha_realizacion') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="ext_publico_objeto" type="text"
                                    ...
                                    name="ext_publico_objeto" value="{{ old('ext_publico_objeto') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" name="ext_ponentes" id="ext_ponentes" cols="30" rows="10"
                                    placeholder="Separar por un ;">{{ old('ext_ponentes') }}</textarea>
                                @error('ext_ponentes')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" name="ext_pais" id="ext_pais" cols="30" rows="10"
                                    placeholder="Separar por un ;">{{ old('ext_pais') }}</textarea>
                                @error('ext_pais')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="ext_participantes" type="number"
                                    ...
                                    name="ext_participantes" value="{{ old('ext_participantes') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="ext_img" type="file" class="form-control @error('ext_img') is-invalid @enderror"
                                    name="ext_img" value="{{ old('ext_img') }}" autocomplete="ext_img" autofocus>
                                @error('ext_img')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
