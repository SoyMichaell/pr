    ...
    @section('content')
        <div class="container-fluid">
            <div class="tile w-100">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <select class="js-example-placeholder-single form-select" name="doc_tipo_documento"
                                id="doc_tipo_documento" disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_numero_documento" type="number"
                                ...
                                autocomplete="doc_numero_documento" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_nombre" type="text"
                                ...
                                value="{{ $docente->doc_nombre }}" autocomplete="doc_nombre" autofocus disabled>
                            @error('doc_nombre')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_apellido" type="text"
                                ...
                                value="{{ $docente->doc_apellido }}" autocomplete="doc_apellido" autofocus disabled>
                            @error('doc_apellido')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_telefono1" type="number"
                                ...
                                value="{{ $docente->doc_telefono1 }}" autocomplete="doc_telefono1" autofocus disabled>
                            @error('doc_telefono1')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_telefono2" type="number"
                                ...
                                value="{{ $docente->doc_telefono2 }}" autocomplete="doc_telefono2" autofocus disabled>
                            @error('doc_telefono2')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_correo_personal" type="email"
                                ...
                                autocomplete="doc_correo_personal" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_correo_institucional" type="email"
                                ...
                                autocomplete="doc_correo_institucional" autofocus disabled>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="doc_departamento" class="col-md-12 col-form-label">{{ __('Departamento *') }}</label>
                        <div class="col-md-12">
                            <input id="doc_departamento" type="text"
                                class="form-control @error('doc_departamento') is-invalid @enderror" name="doc_departamento"
                                value="{{ $docente->doc_departamento }}" autocomplete="doc_departamento" disabled
                                autofocus>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_ciudad" type="text"
                                ...
                                value="{{ $docente->doc_ciudad }}" disabled autocomplete="doc_ciudad" autofocus>
                            @error('doc_ciudad')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_direccion" type="text"
                                ...
                                value="{{ $docente->doc_direccion }}" autocomplete="doc_direccion" disabled autofocus>
                            @error('doc_direccion')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        <label for="doc_estudios" class="col-md-12 col-form-label">{{ __('Nivel estudio *') }}</label>
                        <div class="col-md-12">
                            <input id="doc_estudios" type="text"
                                ...
                                placeholder="Pregrado, Posgrado, Maestria etc.." disabled>
                            @error('doc_estudios')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_fecha_inicio_contra" type="date"
                                ...
                                name="doc_fecha_inicio_contra" value="{{ $docente->doc_fecha_inicio_contra }}" disabled
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_fecha_fin_contra" type="date"
                                ...
                                name="doc_fecha_fin_contra" value="{{ $docente->doc_fecha_fin_contra }}" disabled
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input id="doc_reconocimiento" type="number"
                                ...
                                name="doc_reconocimiento" value="{{ $docente->doc_reconocimiento }}" disabled
