                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="dic_nombre" type="text"
                                    ...
                                    value="{{ old('dic_nombre') }}" autocomplete="dic_nombre" autofocus>
                                @error('dic_nombre')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="dic_apellido" type="text"
                                    ...
                                    value="{{ old('dic_apellido') }}" autocomplete="dic_apellido" autofocus>
                                @error('dic_apellido')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex">
                                <div class="col-md-6">
                                    ...
                                    id="dic_banco" placeholder="Tipo de banco" value="{{old('dic_banco')}}" autocomplete="dic_banco" autofocus>
                                    @error('dic_banco')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    id="dic_numero_cuenta" value="{{old('dic_numero_cuenta')}}" autocomplete="dic_numero_cuenta" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="dic_ciudad" type="text"
                                    ...
                                    value="{{ old('dic_ciudad') }}" autocomplete="dic_ciudad" autofocus>
                                @error('dic_ciudad')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
@endif
=======
        <p>Diligenciar los campos requeridos, para el debido registro del director externo.</p>
    @endsection
@endsection
@section('content')
<div class="tile w-100">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <input id="dic_nombre" type="text" class="form-control @error('dic_nombre') is-invalid @enderror"
                        name="dic_nombre" value="{{ old('dic_nombre') }}" autocomplete="dic_nombre" autofocus>
                    @error('dic_nombre')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <input id="dic_telefono1" type="number"
                        ...
                        value="{{ old('dic_telefono1') }}" autocomplete="dic_telefono1" autofocus>
                    @error('dic_telefono1')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <input id="dic_telefono2" type="number"
                        ...
                        value="{{ old('dic_telefono2') }}" autocomplete="dic_telefono2" autofocus>
                    @error('dic_telefono2')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-md-6">
                ...
                <div class="d-flex">
                    ...
                    <div class="col-md-6">
                        ...
                        id="dic_numero_banco" placeholder="Número de cuenta" value="{{old('dic_numero_banco')}}" autocomplete="dic_numero_banco" autofocus>
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <input id="dic_departamento" type="text"
                        ...
                        value="{{ old('dic_departamento') }}" autocomplete="dic_departamento" autofocus>
                    @error('dic_departamento')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <input id="dic_ciudad" type="text" class="form-control @error('dic_ciudad') is-invalid @enderror"
                        name="dic_ciudad" value="{{ old('dic_ciudad') }}" autocomplete="doc_ciudad" autofocus>
                    @error('dic_ciudad')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
