...
@else
    @extends('layouts.app')
    @section('title')
        <h1 class="titulo"><i class="fa fa-flask"></i> Módulo laboratorios</h1>
        @section('message')<p>Lista de registro laboratorios</p>@endsection
    @endsection
    @section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <a class="btn btn-outline-danger btn-radius" href="{{ url('laboratorio/pdf') }}"
                                title="Generar reporte pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a>
                            <a class="btn btn-outline-primary btn-radius" href="{{ url('laboratorio/export') }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($laboratorios as $laboratorio)
                                    <tr>
                                        ...
                                        <td>{{ $laboratorio->docentes->doc_nombre . ' ' . $laboratorio->docentes->doc_apellido }}
                                        </td>
                                        ...
                                        @if (Auth::user()->per_tipo_usuario == 1 || Auth::user()->per_tipo_usuario == 2)
                                            <td>
                                                <form action="{{ route('laboratorio.destroy', $laboratorio->id) }}"
                                                    ...
                                                    <div class="d-flex">
                                                        <a class="btn btn-sm"
                                                            href="/laboratorio/{{ $laboratorio->id }}"><i
