...
class EgresadosExport implements FromCollection, WithHeadings
{
    ...
    {
        return [
            'Id','Estado estudiante','Tipo de documento','Número de documento',
            'Nombre (s)','Apellido (s)','Telefono 1','Telefono 2',
            'Dirección','Correo electronico','Estrato','Departamento','Municipio',
            'Fecha de nacimiento','Año de ingreso','Ultimo periodo inscrito',
            'Semestre','Tipo de financiamiento','Beca','Estado',
            'Matricula','Promedio general acumulado','Fecha grado','Reconocimientos'
        ];
    }
    public function collection()
    {
        $estudiantes = DB::table('estudiantes')->select(
            'estudiantes.id','pro_nombre','abr','estu_numero_documento',
            'estu_nombre','estu_apellido','estu_telefono1','estu_telefono2',
            'estu_direccion','estu_correo','estu_estrato','dep_nombre',
            'mun_nombre','estu_fecha_nacimiento','estu_ingreso','estu_ult_periodo',
            'estu_semestre','estu_financiamiento','estu_beca',
            'est_nombre','estu_matricula','estu_pga','estu_grado','estu_reconocimiento',
        )
