 ...
 *   https://datatables.net/download/#dt/dt-1.11.4/r-2.2.9/rr-1.2.8/sp-1.4.0
 *
 * Included libraries:
 *   DataTables 1.11.4, Responsive 2.2.9, RowReorder 1.2.8, SearchPanes 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.11.4/r-2.2.9/rr-1.2.8/sp-1.4.0",
